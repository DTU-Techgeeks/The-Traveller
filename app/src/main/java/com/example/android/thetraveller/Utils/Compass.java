...
public class Compass implements SensorEventListener {
    ...
    public interface CompassListener {
        void onNewAzimuth(float direction);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        synchronized (this) {
            ...
            if (success) {
                ...
                mDirection = (float) Math.toDegrees(orientation[0]); // orientation
                mDirection = (mDirection + mDirectionFix + 360) % 360;

                if (mListener != null) {
                    mListener.onNewAzimuth(mDirection);
                }
            }
        }
    }
