...
public class Hyderabad extends AppCompatActivity implements View.OnClickListener{

    public static double lat = 17.3850;
    public static double lon = 78.4867;
    ...
    public void onClick(View view) {
        switch(view.getId())
        {
            ...
            case R.id.cardRestro:
                interestedInfo = 'R';
                startActivity(new Intent(getBaseContext(),CityMaps.class).putExtra("Activity", "Hyderabad"));
                break;
            case R.id.cardHotel:
                interestedInfo = 'H';
                startActivity(new Intent(getBaseContext(),CityMaps.class).putExtra("Activity", "Hyderabad"));
